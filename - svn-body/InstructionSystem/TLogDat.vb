...
#Region "MEMBER"
    ...
    Private taT_Log_DAT As New DataSet1TableAdapters.T_LOG_DATTableAdapter
    Private dtT_Log_DAT As New DataSet1.T_LOG_DATDataTable
...
#End Region
    ...
    Public Sub InsertNewLog(ByVal logType As Integer, ByVal logLevel As LogLevel, ByVal pcName As String, ByVal occDate As Date, _
        ...
        clsLogger.Log(Logger.MessageType.NormalLog, "TLogDat", "InsertNewLog", "Insert New Log Start", "")
        ...
        End If
        clsLogger.Log(Logger.MessageType.NormalLog, "TLogDat", "InsertNewLog", "Insert New Log End", "")
