...
Public Class PIS_SCHEDULER
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "PIS-SCHEDULER Start", "")
    ...
    Protected Overrides Sub OnStop()
        ...
        logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "PIS-SCHEDULER Stop", "")
    End Sub
    ...
    Sub Execute()
        ...
        If CreateBatchFile() Then
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Create Batch Files At Service Start Success", "")
        Else
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Create Batch Files At Service Start Failed", "")
        End If
        ...
        While True
            ...
            intHr = CInt(outStr.Substring(0, 2))
            intMin = CInt(outStr.Substring(2, 2))
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Scheduled time read: " & intHr & ":" & intMin, "")
            If Now.Hour <> intHr Or Now.Minute <> intMin Then Continue While ' Get hour from ini

            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Start Working at Scheduled Time", "")
            ...
            Try
                If CreateBatchFile() Then
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Create Batch Files Success", "")
                    ...
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "dbPeriod = " & outStr, "")
                    'Console.WriteLine("dbPeriod: " & outStr)
                    If deletePro(Integer.Parse(outStr)) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete T_Production_DAT Success", "")
                    ...
                    Else
                        'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Delete T_Production_DAT Failed", "")
                    ...
                    If deleteIns(Integer.Parse(outStr)) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete T_Instruction_Dat Success", "")
                    ...
                    Else
                        'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Delete T_Instruction_Dat Failed", "")
                    ...
                    outStr = iniObj.GetString(INI_APP_NAME_SETUP, INI_KEY_SCREEN, "30", INI_FILE_NAME_SETUP)
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "AS400 Log Period = " & outStr, "")
                    'Console.WriteLine("AS400Period: " & outStr)
                    If deleteLogDat(Integer.Parse(outStr), 0) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete AS400 Log Success", "")
                    ...
                    Else
                        'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Delete AS400 Log Failed", "")
                    ...
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "PLC Log Period = " & outStr, "")
                    'Console.WriteLine("PLCPeriod: " & outStr)
                    If deleteLogDat(Integer.Parse(outStr), 1) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete PLC Log Success", "")
                    ...
                    Else
                        'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Delete PLC Log Failed", "")
                    ...
                    outStr = iniObj.GetString(INI_APP_NAME_SETUP, INI_KEY_SCREEN, "30", INI_FILE_NAME_SETUP)
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Operation Log Period = " & outStr, "")
                    'Console.WriteLine("LogPeriod: " & outStr)
                    If deleteLogDat(Integer.Parse(outStr), 2) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete Operation Log Success", "")
                    ...
                    Else
                        'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Delete Operation Log Failed", "")
                    ...
                    INI_KEY_SCREEN = "dbPeriod"
                    outStr = iniObj.GetString(INI_APP_NAME_SETUP, INI_KEY_SCREEN, "30", INI_FILE_NAME_SETUP)
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "AS400 File Period = " & outStr, "")
                    ...
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "BackupAS400Path = " & dir, "")
                    'Console.WriteLine("dbPeriod: " & outStr)
                    'Console.WriteLine("Path: " & dir)
                    If deleteAS400File(Integer.Parse(outStr), dir) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete AS400 Backup File Success", "")
                    ...
                    Else
                        'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Delete AS400 Backup File Failed", "")
                    ...
                    INI_KEY_SCREEN = "dbPeriod"
                    outStr = iniObj.GetString(INI_APP_NAME_SETUP, INI_KEY_SCREEN, "30", INI_FILE_NAME_SETUP)
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Manual Import File Period = " & outStr, "")
                    'Dim dir As String
                    ...
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "BackupWatchPath = " & dir, "")
                    'Console.WriteLine("dbPeriod: " & outStr)
                    'Console.WriteLine("Path: " & dir)
                    If deleteAS400File(Integer.Parse(outStr), dir) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete Manual Import Backup File Success", "")
                    ...
                    Else
                        'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Delete Manual Import Backup File Failed", "")
                    ...
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Local Log Path = " & dir, "")
                    'Console.WriteLine("dbPeriod: " & outStr)
                    'Console.WriteLine("Path: " & dir)
                    If deleteAS400File(Integer.Parse(outStr), dir) Then
                        'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Delete AS400 Backup File Success", "")
                    ...
                    logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "Start call utlrecv", "")
                    Shell(My.Application.Info.DirectoryPath & "\utlrecv.bat", AppWinStyle.Hide, True, 3000)

                    'logger.SystemEnd()
                    'logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "Main", "End of clear old data service", "")
                ...
                Else
                    'logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", "Create Batch Files Fail", "")
            ...
            Catch ex As Exception
                logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "Main", ex.StackTrace, "")
            End Try
        End While
    End Sub
    ...
    Private Function deletePro(ByVal expDate As Integer) As Boolean
        ...
        Try
            ...
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "deletePro", "T_Production_DAT " & intResult.ToString & " records deleted.", "")
            Return True
        Catch ex As Exception
            strErrorMessage = ex.Message
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "deletePro", "Exception = " & ex.StackTrace, "")
            Return False
        End Try
    ...
    Private Function deleteIns(ByVal expDate As Integer) As Boolean
        ...
        Try
            ...
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "deleteIns", "T_Instruction_DAT " & intResult.ToString & " records deleted.", "")
            Return True
        Catch ex As Exception
            strErrorMessage = ex.Message
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "deleteIns", "Exception = " & ex.StackTrace, "")
            Return False
        End Try
    ...
    Private Function deleteLogDat(ByVal expDate As Integer, ByVal logType As Integer) As Boolean
        ...
        Try
            ...
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "deleteLogDat", "T_LOG_DAT Log Type = " & logType & ", " & intResult.ToString & " records deleted.", "")
            Return True
        Catch ex As Exception
            strErrorMessage = ex.Message
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "deleteLogDat", "Exception = " & ex.StackTrace, "")
            Return False
        End Try
    ...
    Private Function deleteAS400File(ByVal expDate As Integer, ByVal dir As String) As Boolean
        ...
        Try
            If di.Exists Then
                ...
                Return True
            Else
                logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "deleteAS400File", "Path: '" & dir & "' don't exist.", "")
                Return False
            End If
        Catch ex As Exception
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "deleteAS400File", ex.StackTrace, "")
            Return False
        End Try
    ...
    Private Function WriteUtlRecvBat() As Boolean
        Try
            ...
            Writer.Close()
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "WriteUtlSendBat", "Create " & FILE_NAME_UTLRECV & " success", "")
            Return True
        Catch ex As Exception
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "WriteUtlRecvBat", ex.StackTrace, "")
            Return False
        End Try
    End Function
    ...
    Private Function WriteUtlSendBat() As Boolean
        Try
            ...
            Writer.Close()
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "WriteUtlSendBat", "Create " & FILE_NAME_UTLSEND & " success", "")
            Return True
        Catch ex As Exception
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "WriteUtlSendBat", ex.StackTrace, "")
            Return False
        End Try
    End Function
    ...
    Private Function WriteRecvJobOkBat() As Boolean
        Try
            ...
            Writer.Close()
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "WriteRecvJobOkBat", "Create " & FILE_NAME_RECV_JOB_OK & " success", "")
            Return True
        Catch ex As Exception
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "WriteRecvJobOkBat", ex.StackTrace, "")
            Return False
        End Try
    End Function
    ...
    Private Function WriteRecvJobErrorBat() As Boolean
        Try
            ...
            Writer.Close()
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "WriteRecvJobErrorBat", "Create " & FILE_NAME_RECV_JOB_ERROR & " success", "")
            Return True
        Catch ex As Exception
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "WriteRecvJobErrorBat", ex.StackTrace, "")
            Return False
        End Try
    End Function
    ...
    Private Function WriteSendJobOkBat() As Boolean
        Try
            ...
            Writer.Close()
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "WriteSendJobOkBat", "Create " & FILE_NAME_SEND_JOB_OK & " success", "")
            Return True
        Catch ex As Exception
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "WriteSendJobOkBat", ex.StackTrace, "")
            Return False
        End Try
    End Function
    ...
    Private Function WriteSendJobErrorBat() As Boolean
        Try
            ...
            Writer.Close()
            logger.Log(Common.Logger.MessageType.NormalLog, "PIS_SCHEDULER", "WriteSendJobErrorBat", "Create " & FILE_NAME_SEND_JOB_ERROR & " success", "")
            Return True
        Catch ex As Exception
            logger.Log(Common.Logger.MessageType.ErrorLog, "PIS_SCHEDULER", "WriteSendJobErrorBat", ex.StackTrace, "")
            Return False
        End Try
    End Function
