...
select substring(EuR03.[MODEL PATTERN],1,3), substring(EuR03.[MODEL PATTERN],4,3) + '*' + substring(EuR03.[MODEL PATTERN],8,1)
from EuR03
...
from T_MODEL_OPTION_ROW as oprow, T_OPTION_MST as opmst, EuR03 as imp
