...
--select substring(GexpR03.[MODEL PATTERN],1,3), substring(GexpR03.[MODEL PATTERN],4,3) + '*' + substring(GexpR03.[MODEL PATTERN],8,1)
--from GexpR03
...
from T_MODEL_OPTION_ROW as oprow, T_OPTION_MST as opmst, GexpR03 as imp
...
from T_MODEL_OPTION_ROW as oprow, T_OPTION_MST as opmst, GexpR03 as imp
where imp.[MODEL PATTERN] LIKE replace(oprow.MODEL_YEAR_PATTERN+oprow.SUFFIX_CODE_PATTERN,'*','%')
 AND opmst.OPTION_DISPLAY = 'G/EXP'
